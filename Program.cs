...
{
Console.WriteLine("Olá, meu nome é Duny! Hoje irei te ajudar em seus calculos.");
Console.WriteLine("Antes de começarmos, gostaria de saber seu nome");
...
Console.WriteLine(nome + " eu tenho uma lista de seis operações matemáticas que são elas:Soma;\nSubtração;\nMultiplicação;\nDivisão;\nRaiz Quadrada;\nPotência");
...
{
Console.WriteLine("Digite dois números");
Console.Write("1° número: ");double valor10=Convert.ToDouble(Console.ReadLine());
Console.Write("2° número: ");double valor11=Convert.ToDouble(Console.ReadLine());
